...
Builder.load_file('screens/gamescreen4.kv')
...
class GameScreen4(Screen):
        ...
        def dismiss_dialog(self, *args):
            ...
            self.manager.current = '_game_screen5_'
            self.manager.transition.direction = 'left'
            self.ids.wrong1.source = 'gifs/orig2/fear.gif'
            self.ids.wrong2.source = 'gifs/orig2/sad.gif'
            self.ids.wrong3.source = 'gifs/orig2/happy.gif'
            self.ids.right1.source = 'gifs/orig2/surprise.gif'
            self.ids.right2.source = 'gifs/orig2/surprise.gif'
            self.ids.right3.source = 'gifs/orig2/surprise.gif'
