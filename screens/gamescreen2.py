...
Builder.load_file('screens/gamescreen2.kv')
...
class GameScreen2(Screen):
        ...
        def dismiss_dialog(self, *args):
            ...
            self.manager.current = '_game_screen3_'
            self.manager.transition.direction = 'left'
            self.ids.wrong1.source = 'gifs/orig2/surprise.gif'
            self.ids.wrong2.source = 'gifs/orig2/disgust.gif'
            self.ids.wrong3.source = 'gifs/orig2/sad.gif'
            self.ids.right1.source = 'gifs/orig2/angry.gif'
            self.ids.right2.source = 'gifs/orig2/angry.gif'
            self.ids.right3.source = 'gifs/orig2/angry.gif'
