...
class GameScreen(Screen):
        ...
        def dismiss_dialog(self, *args):
            ...
            self.manager.current = '_game_screen2_'
            self.manager.transition.direction = 'left'
            self.ids.wrong1.source = 'gifs/orig2/fear.gif'
            self.ids.wrong2.source = 'gifs/orig2/angry.gif'
            self.ids.wrong3.source = 'gifs/orig2/disgust.gif'
            self.ids.right1.source = 'gifs/orig2/happy.gif'
            self.ids.right2.source = 'gifs/orig2/happy.gif'
            self.ids.right3.source = 'gifs/orig2/happy.gif'
