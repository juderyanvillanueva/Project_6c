...
source.include_exts = py,png,jpg,kv,atlas,gif,txt,mp4,h5,json,ttf,xml,cfg
...
presplash.filename = %(source.dir)s/images/blurredbg.png
...
android.permissions = android.permissions.INTERNET,CAMERA
